...
public class BossBarCommand {
	...
	public static final SuggestionProvider<ServerCommandSource> SUGGESTION_PROVIDER = (commandContext, suggestionsBuilder) -> CommandSource.suggestIdentifiers(commandContext.getSource().getMinecraftServer().getBossBarManager().getIds(), suggestionsBuilder);

	public static void register (CommandDispatcher<ServerCommandSource> dispatcher) {
		dispatcher.register(
						CommandManager.literal("bossbar").requires(
										...
										CommandManager.literal(
														...
														CommandManager.argument(
																		"id",
																		IdentifierArgumentType.identifier()
														).suggests(SUGGESTION_PROVIDER).then(
																		CommandManager.literal("name").then(
																						CommandManager.argument(
																										"name",
																										TextArgumentType.text()
																						).executes(
																		...
																		CommandManager.literal(
																						...
																						CommandManager.literal("pink").executes(
	...
	private static int getValue (ServerCommandSource source, CommandBossBar bossBar) {
		source.sendFeedback(
						new TranslatableText("commands.bossbar.get.value", bossBar.toHoverableText(), bossBar.getValue()), true);
	...
	private static int setColor (ServerCommandSource source, CommandBossBar bossBar, Color color) throws CommandSyntaxException {
	...
	private static int setStyle (ServerCommandSource source, CommandBossBar bossBar, Style style) throws CommandSyntaxException {
